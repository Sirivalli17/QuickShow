...
export const isAdmin = async (req, res) => {
  try {
    console.log('Reached isAdmin endpoint');
    console.log('User from middleware:', req.user); // Ensure protectAdmin adds this

    res.status(200).json({ isAdmin: req.user?.isAdmin || false });
  } catch (err) {
