...
const ListShows = () => {
  ...
  return !loading ? (
    <>
      ...
      <div className='max-s-4xl mt-6 overflow-x-auto'>
        <table className='w-full border-collapse rounded-md overflow-hidden
        text-nowrap'>
          <thead>
            <tr className='bg-primary/20 text-left text-white'>
              <th className='p-2 font-medium p1-5'>Movie Name</th>
              <th className='p-2 font-medium p1-5'>Show Time</th>
              <th className='p-2 font-medium p1-5'>Total Bookings</th>
              <th className='p-2 font-medium p1-5'>Earnings</th>
            </tr>
          </thead>
